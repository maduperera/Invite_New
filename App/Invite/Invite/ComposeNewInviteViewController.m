...
-(void) sendEmail: (PFObject *) currentEvent {
    ...
    NSString *startTime = [currentEvent objectForKey:@"startTime"];
    NSString *endTime =  [currentEvent objectForKey:@"endTime"];
    NSString *contactNumber = [currentEvent objectForKey:@"contactNo"];
    NSString *date =[currentEvent objectForKey:@"eventDate"];
    NSString *address = [currentEvent objectForKey:@"address"];
    NSString *sender = [[PFUser currentUser] objectForKey:@"username"];
